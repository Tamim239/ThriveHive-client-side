...
const [isOpen, setIsOpen] = useState(true)
  ...
  return (
    ...
    <nav className="relative bg-white shadow dark:bg-gray-800">
      <div className="container md:px-6 px-1 py-4 mx-auto md:flex md:justify-between md:items-center">
        <div className="flex items-center justify-between">
          ...
          <img className="w-auto h-6 sm:w-10 rounded-2xl object-cover" src={logo} alt="" />
