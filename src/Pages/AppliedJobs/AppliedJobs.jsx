...
export const AppliedJobs = () => {
  ...
  const PDFContent = ({resume}) => (
    <Document>
      <Page>
        <Text>Summary of Applied Jobs <br />
        {resume}
        </Text>
        ...
        {jobData?.map((item) => (
          ...
          >
            ...
            <div className="border-2 text-center flex items-center justify-center gap-6">
              ...
              <PDFDownloadLink document={<PDFContent resume={item?.resume} />} fileName="summary.pdf">
                {({ loading }) => (loading ? "Loading..." : "Download Summary")}
              </PDFDownloadLink>
            </div>
          </article>
        ))}
