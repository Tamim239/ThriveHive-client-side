...
export const AddJob = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    axios.post(`${import.meta.env.VITE_API_URL}/postJobs`, jobData).then((data) => {
        ...
        <section className=" p-2 md:p-6 mx-auto bg-white dark:bg-[#1A103D] rounded-md shadow-md ">
          ...
          <form onSubmit={handleFormSubmit}>
            <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-4">
              ...
              <div className=" max-sm:col-span-2 md:col-span-3">
              ...
              <div className="flex flex-col gap-2 col-span-1 max-md:col-span-2">
